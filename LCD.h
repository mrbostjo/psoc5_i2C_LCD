...
#define I2C_MasterSendStop()  I2C_MasterCommand(MasterSendStop)()
#define I2C_MasterWriteByte(byteData) I2C_MasterCommand(MasterWriteByte)(byteData)
...
typedef enum { POSITIVE, NEGATIVE } t_backlighPol;
    ...
    @param      backlightPin[in] LCD backlight pin map on IO extender module
    @param      pol[in] LCD backlight polarity
    */
